...
| **`dannflow-masterplan`**      | **Core.** The SaaS project orchestrator. Use this when you want to start a new project, create a Masterplan, sync a GitHub Project board, or initialize infrastructure.                                                                           |
| **`dannflow-task`**            | **Core.** The autonomous task lifecycle manager. Run this to execute a specific task from `MASTERPLAN.md` end-to-end, including quality gates and human verification.                                                                             |
| **`dannflow-update`**          | **Core.** The surgical upstream synchronizer. Run this when you need to safely update an old DannFlow repository from upstream without destroying custom business logic.                                                                          |
