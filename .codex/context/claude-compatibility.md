...
| Documentation Governance       | Log architectural/service/type/schema updates into `docs/PENDING_DOC_UPDATES.md` as code is written; prune notes on code revisions; transfer notes to `docs/` and clear before `/close-task` or merging to `main`. |
