...
echo "--------------------------------------------------------"
echo "[CHECKPOINT] ${NEXT_PUBLIC_SITE_NAME:-DANNFLOW} READY"
echo "--------------------------------------------------------"
echo ""
...
echo "4. If any schema modifications occurred during this session, log an entry in docs/PENDING_DOC_UPDATES.md to ensure the documentation stays in sync."
echo "---"
echo ""
